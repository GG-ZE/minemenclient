 ...
 */
package mmc.util.openauth.microsoft;
...
import mmc.util.openauth.microsoft.model.request.MinecraftLoginRequest;
import mmc.util.openauth.microsoft.model.request.XSTSAuthorizationProperties;
import mmc.util.openauth.microsoft.model.request.XboxLiveLoginProperties;
import mmc.util.openauth.microsoft.model.request.XboxLoginRequest;
import mmc.util.openauth.microsoft.model.response.MicrosoftRefreshResponse;
import mmc.util.openauth.microsoft.model.response.MinecraftLoginResponse;
import mmc.util.openauth.microsoft.model.response.MinecraftProfile;
import mmc.util.openauth.microsoft.model.response.MinecraftStoreResponse;
import mmc.util.openauth.microsoft.model.response.XboxLoginResponse;
