...
public class SplashProgress {
	...
	public static void drawSplash(TextureManager tm) {
		...
		if(splash == null) {
			splash = new ResourceLocation("minemen/splash.png");
		}
	...
	private static void drawProgress() {
		...
		if(ufr == null) {
			ufr = UnicodeFontRenderer.getFontOnPC("Vrinda", 20);
		}
		...
		Gui.drawRect(0, sr.getScaledHeight() - 35, sr.getScaledWidth(), sr.getScaledHeight(), new Color(0, 0, 0, 80).getRGB());
		...
		Gui.drawRect(0, sr.getScaledHeight() - 2, (int)calc, sr.getScaledHeight(), new Color(255, 180, 0, 255).getRGB());
		
		Gui.drawRect(0, sr.getScaledHeight() - 2, sr.getScaledWidth(), sr.getScaledHeight(), new Color(0, 0, 0, 30).getRGB());
	}
