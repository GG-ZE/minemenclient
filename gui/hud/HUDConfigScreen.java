...
public class HUDConfigScreen extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		this.drawHollowRect(0, 0, this.width - 1, this.height - 1, new Color(255, 180, 0, 255).getRGB());
		...
		for(IRenderer renderer : renderers.keySet()) {
			...
			this.drawHollowRect(pos.getAbsoluteX(), pos.getAbsoluteY(), renderer.getWidth(), renderer.getHeight(), 0x00000000);
