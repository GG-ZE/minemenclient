package mmc.gui.auth.microsoft;
...
import mmc.gui.auth.GuiLogin;
import mmc.gui.auth.SessionChanger;
...
public class GuiLoginMicrosoft extends GuiScreen {
    ...
    public void initGui() {
        ...
        (this.username = new GuiTextField(100, this.fontRendererObj, this.width / 2 - 50 - 10, sr.getScaledHeight() / 2 - 50, 120, 20)).setFocused(false);
