...
public class CosmeticDogPet extends CBase {
	  WolfModel wolfModel;
	  
	  public static final ResourceLocation TEXTURE = new ResourceLocation("minemen/wolfModel.png");
	  ...
	  class WolfModel extends CosmeticModelBase {
	    ...
	    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale) {
	      ...
	      if (Minecraft.getMinecraft().thePlayer.isSneaking()) {
				GlStateManager.translate(0.35F, -0.25F, -0.2F);
				GlStateManager.rotate(25, 3.0F, 0.0F, 0.0F);
	      } else {
	    	  GlStateManager.translate(0.35F, -0.4F, 0.0F);
	      }
